...
NOTAS:
- Las clases suelen estan en sus propios archivos JS para tener el proyecto modularizado.
- Al usar getters y setters ponerle un nombre interno a las variables distinto del de los métodos. De lo contrario se producirían bucles infinitos al llamar a los getters/setters. En el ejemplo anterior se usaron los nombres internos width y _height para las propiedades width y height por ejemplo.
