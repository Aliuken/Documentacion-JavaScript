...
Los string son inmutables, lo cuál implica que todos sus métodos no modifican el objeto String sobre el que se apican, sino que devuelven un nuevo string como resultado.
...
let matchAllResultIterator = message.matchAll(globalRegExp); //Sólo funciona con el flag g
...
console.log("search_REx:", message.search(emailRegExp));
console.log("search_glo:", message.search(globalRegExp));
console.log("match_REx:", message.match(emailRegExp));
console.log("match_glo:", message.match(globalRegExp));
console.log("matchAll_glo:", matchAllResultIterator);
console.log("matchAll_glo_0_val:", matchAllResultIterator_0.value);
console.log("matchAll_glo_0_don:", matchAllResultIterator_0.done);
console.log("matchAll_glo_1_val:", matchAllResultIterator_1.value);
console.log("matchAll_glo_1_don:", matchAllResultIterator_1.done);
console.log("matchAll_glo_2_val:", matchAllResultIterator_2.value);
console.log("matchAll_glo_2_don:", matchAllResultIterator_2.done);
console.log("replace_str: '%s'", message.replace("blah", "bleh"));
console.log("replace_REx: '%s'", message.replace(emailRegExp, "bleh"));
console.log("replace_glo: '%s'", message.replace(globalRegExp, "bleh"));
console.log("replaceAll_str: '%s'", message.replaceAll("blah", "blih"));
console.log("replaceAll_glo: '%s'", message.replaceAll(globalRegExp, "blih")); //Sólo funciona con el flag g
...
search_REx: 17
search_glo: 17
match_REx: Array [ "blahblah1@blah.com" ]
match_glo: Array [ "blahblah1@blah.com", "blahblah2@blah.com" ]
matchAll_glo: RegExp String Iterator {  }
matchAll_glo_0_val: Array [ "blahblah1@blah.com" ]
matchAll_glo_0_don: false
matchAll_glo_1_val: Array [ "blahblah2@blah.com" ]
matchAll_glo_1_don: false
matchAll_glo_2_val: undefined
matchAll_glo_2_don: true
replace_str: '  Mis emails son blehblah1@blah.com y blahblah2@blah.com.  '
replace_REx: '  Mis emails son bleh y blahblah2@blah.com.  '
replace_glo: '  Mis emails son bleh y bleh.  '
replaceAll_str: '  Mis emails son blihblih1@blih.com y blihblih2@blih.com.  '
replaceAll_glo: '  Mis emails son blih y blih.  '
